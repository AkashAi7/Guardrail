 ...
 */
export async function importRulesFromFile(filePath: string): Promise<CustomRuleConfig[]> {
 ...
 */
export function getSupportedExtensions(): { [key: string]: string[] } {
    return {
 ...
 */
export function generateSampleTextRules(): string {
