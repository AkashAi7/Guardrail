...
exports.parseNaturalLanguageRules = parseNaturalLanguageRules;
exports.extractDocumentTitle = extractDocumentTitle;
 ...
 */
function parseNaturalLanguageRules(text) {
    const rules = [];
...
function createRuleName(segment, keyword) {
...
function escapeRegexIfNeeded(str) {
...
//# sourceMappingURL=naturalLanguageParser.js.map