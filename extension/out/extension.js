...
`;
    ...
    context.subscriptions.push(diagnosticCollection, statusBarItem, analyzeCmd, clearCmd, showQuickPickCmd, showIssuesPanelCmd, reloadCmd, initCmd, importCmd, importUrlCmd, createRuleCmd, setupOrgCmd, manageRulesCmd, onSave, onOpen);
...
async function analyzeDocument(document) {
    ...
    let findings = [];
    let analysisSource = 'Regex'; // Track which engine was used
